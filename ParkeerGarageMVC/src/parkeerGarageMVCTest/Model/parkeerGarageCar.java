...
public abstract class parkeerGarageCar {
	// De locatie van de auto in de garage
	private parkeerGarageLocation location;
	 ...
	 */
	public parkeerGarageCar() {

	}

	// @return Geeft de locatie weer van de auto
	public parkeerGarageLocation getLocation() {
		return location;
	}

	// @param Verandert de locatie van de auto
	public void setLocation(parkeerGarageLocation location) {
